  ...
  return (
    <div className="bg-white px-8 py-6 min-h-screen">
      ...
      <div className="pt-6 space-y-6">
        <h2 className="text-gray-700 font-bold text-lg">{params.slug}</h2>
        ...
        <div className="space-y-2">
          ...
          <RadioGroup defaultValue="default" className="flex">
            <div className="flex items-center space-x-2 border-2 border-blue-600 rounded px-4 py-1">
              <RadioGroupItem
                value="default"
                id="r1"
            ...
            <div className="flex items-center space-x-2 border-2 border-gray-200 rounded px-4 py-1">
              <RadioGroupItem
                value="comfortable"
                id="r2"
                className="text-blue-600 border-2 border-gray-200"
              />
              <label
                htmlFor="r2"
                className="text-sm font-semibold text-gray-800"
