            ...
            <Accordion type="multiple" className="space-y-3">
              <AccordionItem value="1" className="border rounded-lg p-6">
                ...
                <div className="mt-5 max-md:max-w-full">
                  <form className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:items-stretch">
                    ...
                    <div className="bg-blue-300 grow rounded-md p-6">
                      <button className="justify-center items-stretch self-end px-4 py-2 mt-4 mr-6 text-sm font-semibold leading-4 text-center text-sky-100 bg-blue-200 rounded aspect-[2.03] max-md:mr-2.5">
                        Save
                      </button>
                    </div>
                  </form>
