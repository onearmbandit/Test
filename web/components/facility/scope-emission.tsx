        ...
        <div className="flex gap-5 items-center max-md:flex-col max-md:gap-0">
          ...
          <div className="bg-sky-50/50 grow rounded-md p-6 space-y-6">
            ...
            <p className="leading-6 w-[25rem]">
              Scope 1 emissions are direct greenhouse gas (GHG) emissions that a
              company generates while performing its business activities. These
              emissions come from sources that are owned or controlled by an
              organization.
            </p>
          </div>
        </div>
