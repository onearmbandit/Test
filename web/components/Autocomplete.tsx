    ...
    <div className='relative'>
      {val == '' ? (
        <Input
          ...
          disabled={!ready}
          placeholder='Address'
          className='text-slate-500 text-sm font-light mt-3 leading-4 items-stretch bg-gray-50 self-stretch justify-center px-2 py-7 rounded-md max-md:max-w-full'
        />
      ) : (
        <textarea
