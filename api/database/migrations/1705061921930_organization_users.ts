...
export default class extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.string('email').nullable().comment('Specify the invited mail')

      table.string('first_name').nullable().comment('Specify the invited first name')

      table.string('last_name').nullable().comment('Specify the invited last name')
