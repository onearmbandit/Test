...
export default class UpdateFacilityValidator {
  ...
  public schema = schema.create({
    name: schema.string.optional({}, [rules.minLength(1), rules.maxLength(255)]),

    address: schema.string.optional({}, [rules.minLength(5), rules.maxLength(500)]),
  })

  public messages = {
    'name.minLength': 'Name must be at least 1 characters long.',
